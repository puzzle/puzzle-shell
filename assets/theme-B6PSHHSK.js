import{i as e}from"./preload-helper-Cs4UwXAW.js";import{q as t,z as n}from"./iframe-CB4V54db.js";var r=e((()=>{})),i=e((()=>{})),a=e((()=>{})),o=e((()=>{})),s=e((()=>{})),c=e((()=>{}));function l(){return typeof window<`u`}function u(){return l()&&`pzshBreakpoint`in window&&typeof window.pzshBreakpoint==`number`&&window.pzshBreakpoint||f}function d(e){if(!l())return;let t=document.createElement(`style`);t.innerText=e.toString(),document.querySelector(`body`)?.appendChild(t)}var f,p,m,h=e((()=>{n(),r(),i(),a(),o(),s(),c(),f=800,p=t`
  /* Base colors */
