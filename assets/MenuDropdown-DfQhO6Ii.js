import{i as d,s as c,x as h}from"./lit-element-CMpGwy9_.js";import{t as g}from"./custom-element-BhZVzxrc.js";import{n as v}from"./property-D-w_Ad9s.js";import{t as i}from"./theme-BJxUQc3L.js";import{r as f,i as b,n as z}from"./Topbar-TG5-8jaE.js";import{e as y}from"./class-map-BpKUc_RR.js";import"./Icon-Dbt3sJO2.js";var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,m=(e,o,n,r)=>{for(var t=r>1?void 0:r?x(o,n):o,a=e.length-1,s;a>=0;a--)(s=e[a])&&(t=(r?s(o,n,t):s(t))||t);return r&&t&&w(o,n,t),t};let p=class extends c{constructor(){super(...arguments),this.href="#"}focus(e){var o,n;(n=(o=this.shadowRoot)==null?void 0:o.querySelector("a"))==null||n.focus(e)}render(){return h`<a href="${this.href}" role="menuitem">
      <slot></slot>
    </a>`}};p.styles=[i,d`
      a {
        display: flex;
