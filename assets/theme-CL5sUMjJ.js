import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{d as t,n}from"./iframe-CEXs4UB1.js";function r(){return typeof window<`u`}function i(){return r()&&`pzshBreakpoint`in window&&typeof window.pzshBreakpoint==`number`&&window.pzshBreakpoint||o}function a(e){if(!r())return;let t=document.createElement(`style`);t.innerText=e.toString(),document.querySelector(`body`)?.appendChild(t)}var o,s,c;function l(){return(l=e((()=>{n(),o=800,s=t`
  /* Base colors */
