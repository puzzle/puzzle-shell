import{i as o}from"./lit-element-cycI6O1e.js";const e=800;function s(){return"pzshBreakpoint"in window&&typeof window.pzshBreakpoint=="number"&&window.pzshBreakpoint||e}const p=o`
  /* Base colors */
...
`,t=Object.assign(o`
  ...
  `,{get breakpoint(){return s()}});function n(h){var a;const r=document.createElement("style");r.innerText=h.toString(),(a=document.querySelector("body"))==null||a.appendChild(r)}n(o`
  :root {
    ${p}
  }
`);export{t};
