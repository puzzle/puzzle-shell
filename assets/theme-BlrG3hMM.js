import{i as o}from"./iframe-CTRJx84E.js";function a(){return typeof window<"u"}const e=800;function s(){return a()&&"pzshBreakpoint"in window&&typeof window.pzshBreakpoint=="number"&&window.pzshBreakpoint||e}const p=o`
  /* Base colors */
...
`,t=Object.assign(o`
  ...
  `,{get breakpoint(){return s()}});function n(h){if(!a())return;const r=document.createElement("style");r.innerText=h.toString(),document.querySelector("body")?.appendChild(r)}n(o`
  :root {
    ${p}
  }
`);export{t};
