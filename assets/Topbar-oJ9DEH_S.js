import{i as u,h as g,k as r}from"./lit-element-CxgFg0AR.js";import{t as v}from"./custom-element-BTbnI5vI.js";import{n as b}from"./property-t_taj8Q_.js";import{R as z}from"./class-map-BlpslTfp.js";import{t as l}from"./theme-EnFTGyLY.js";import"./Icon-4SjO7Wym.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function m(e){return b({...e,state:!0,attribute:!1})}function w(e,t){return e&&e instanceof HTMLElement&&(e.nodeName.toLowerCase()===t||e.closest(t)!=null)}function C(e){e.getBoundingClientRect().bottom>window.innerHeight&&e.scrollIntoView(!1),e.getBoundingClientRect().top<0&&e.scrollIntoView()}function k(e,t){if(t instanceof KeyboardEvent&&t.type==="keydown"&&(t.key==="ArrowUp"||t.key==="ArrowDown")){const o=e();let s=o.findIndex(a=>a===document.activeElement);t.key==="ArrowUp"?s-=1:t.key==="ArrowDown"&&(s+=1);const n=o[s];n&&(n.focus(),C(n),t.preventDefault())}}var M=Object.defineProperty,x=Object.getOwnPropertyDescriptor,E=(e,t,o,s)=>{for(var n=s>1?void 0:s?x(t,o):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(n=(s?i(t,o,n):i(n))||n);return s&&n&&M(t,o,n),n};let c=class extends g{render(){return r``}};c.styles=[l,u`
      :host {
        position: absolute;
    ...
    `];d([m()],h.prototype,"menuAvailable",2);d([m()],h.prototype,"menuOpen",2);d([b({type:String})],h.prototype,"href",2);h=d([v("pzsh-topbar")],h);export{w as i,k as n,m as r};
