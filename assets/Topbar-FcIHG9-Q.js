import{i as e}from"./preload-helper-xPQekRTU.js";import{G as t,H as n,V as r,X as i}from"./iframe-DKx5S2XV.js";import{a,i as o,n as s,r as c,t as l}from"./decorate-46yoN6xj.js";import{n as u,r as d,t as f}from"./property-BfM0EYHu.js";import{n as p,t as m}from"./class-map-D2T8PK34.js";import{n as h,t as g}from"./theme-H4ouheD0.js";import{n as _}from"./Icon-DxeLBuCj.js";function v(e){return d({...e,state:!0,attribute:!1})}var y=e((()=>{u()})),b=e((()=>{})),x=e((()=>{})),S=e((()=>{})),C=e((()=>{})),w=e((()=>{})),T=e((()=>{})),E=e((()=>{o(),u(),y(),b(),x(),S(),C(),w(),T()}));function D(e,t){return e&&e instanceof HTMLElement&&(e.nodeName.toLowerCase()===t||e.closest(t)!=null)}function O(e){e.getBoundingClientRect().bottom>window.innerHeight&&e.scrollIntoView(!1),e.getBoundingClientRect().top<0&&e.scrollIntoView()}var k=e((()=>{}));function A(e,t){if(t instanceof KeyboardEvent&&t.type===`keydown`&&(t.key===`ArrowUp`||t.key===`ArrowDown`)){let n=e(),r=n.findIndex(e=>e===document.activeElement);t.key===`ArrowUp`?--r:t.key===`ArrowDown`&&(r+=1);let i=n[r];i&&(i.focus(),O(i),t.preventDefault())}}var j=e((()=>{k()})),M,N=e((()=>{r(),c(),g(),s(),M=class extends n{static{this.styles=[h,i`
      :host {
        position: absolute;
    ...
    `]}render(){return t``}},M=l([a(`pzsh-backdrop`)],M)})),P,F=e((()=>{r(),E(),c(),f(),m(),k(),j(),g(),N(),s(),P=class extends n{static{this.styles=[h,i`
      nav {
        position: absolute;
        top: var(--pzsh-topbar-height);
        left: 0;
    ...
    `}},l([v()],P.prototype,`open`,void 0),l([d({type:String})],P.prototype,`scrollContainerSelector`,void 0),P=l([a(`pzsh-menu`)],P)})),I,L=e((()=>{r(),E(),c(),f(),g(),_(),s(),I=class extends n{static{this.styles=[h,i`
      :host {
        display: flex;
        align-items: center;
        height: var(--pzsh-topbar-height);
    ...
    `]}constructor(){super(),this.menuAvailable=!1,this.menuOpen=!1,this.href=``,this.handleMenuChange=this.handleMenuChange.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`pzsh-menu-change`,this.handleMenuChange,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`pzsh-menu-change`,this.handleMenuChange,!0)}handleMenuChange(e){if(e.stopPropagation(),e instanceof CustomEvent){let{available:t,open:n}=e.detail;this.menuAvailable=t,this.menuOpen=n}}toggleMenu(){this.dispatchEvent(new CustomEvent(`pzsh-menu-toggle`))}renderMenuButton(){if(this.menuAvailable){let e=this.menuOpen?`multiply`:`bars`;return t`<button
      ...
      </button>`}return null}renderLogo(){return this.href?t`<a class="logo-link" href=${this.href}>
          <slot></slot>
        </a>`:t`<slot></slot>`}render(){return t`${this.renderLogo()} ${this.renderMenuButton()} `}},l([v()],I.prototype,`menuAvailable`,void 0),l([v()],I.prototype,`menuOpen`,void 0),l([d({type:String})],I.prototype,`href`,void 0),I=l([a(`pzsh-topbar`)],I)}));export{A as a,E as c,j as i,y as l,F as n,k as o,N as r,D as s,L as t,v as u};