import{i as o}from"./lit-element-CxgFg0AR.js";function s(){return typeof window<"u"}const n=800;function p(){return s()&&"pzshBreakpoint"in window&&typeof window.pzshBreakpoint=="number"&&window.pzshBreakpoint||n}const h=o`
  /* Base colors */
...
`,c=Object.assign(o`
  ...
  `,{get breakpoint(){return p()}});function z(e){var a;if(!s())return;const r=document.createElement("style");r.innerText=e.toString(),(a=document.querySelector("body"))==null||a.appendChild(r)}z(o`
  :root {
    ${h}
  }
`);export{c as t};
