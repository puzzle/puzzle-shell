import{i as e}from"./preload-helper-xPQekRTU.js";import{G as t,H as n,V as r,X as i}from"./iframe-DKx5S2XV.js";import{a,n as o,r as s,t as c}from"./decorate-46yoN6xj.js";import{r as l,t as u}from"./property-BfM0EYHu.js";import{n as d,t as f}from"./theme-H4ouheD0.js";var p,m=e((()=>{r(),s(),f(),o(),p=class extends n{static{this.styles=[d,i`
      :host {
    ...
    `]}render(){return t`
      ...
      <slot></slot>
    `}},p=c([a(`pzsh-footer`)],p)})),h,g=e((()=>{r(),s(),u(),f(),o(),h=class extends n{constructor(...e){super(...e),this.href=`#`}static{this.styles=[d,i`
      a {
        display: flex;
        align-items: center;
