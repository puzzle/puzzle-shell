import{i as e}from"./preload-helper-xPQekRTU.js";import{G as t,H as n,V as r,X as i}from"./iframe-DKx5S2XV.js";import{a,n as o,r as s,t as c}from"./decorate-46yoN6xj.js";import{r as l,t as u}from"./property-BfM0EYHu.js";import{a as d,c as f,i as p,o as m,s as h,u as g}from"./Topbar-FcIHG9-Q.js";import{n as _,t as v}from"./class-map-D2T8PK34.js";import{n as y,t as b}from"./theme-H4ouheD0.js";import{n as x}from"./Icon-DxeLBuCj.js";var S,C=e((()=>{r(),s(),u(),b(),o(),S=class extends n{constructor(...e){super(...e),this.href=`#`}static{this.styles=[y,i`
      a {
        display: flex;
        align-items: center;
    ...
    `]}focus(e){this.shadowRoot?.querySelector(`a`)?.focus(e)}updated(){this.applyHostAttributes()}render(){return t`<a href="${this.href}" role="menuitem">
      <slot></slot>
    </a>`}applyHostAttributes(){let e=this.shadowRoot?.querySelector(`a`);e&&Array.from(this.attributes).filter(({name:e})=>e!==`href`).forEach(({name:t,value:n})=>{e.setAttribute(t,n)})}},c([l({type:String})],S.prototype,`href`,void 0),S=c([a(`pzsh-menu-action`)],S)})),w,T=e((()=>{r(),f(),s(),v(),m(),p(),b(),x(),o(),w=class extends n{static{this.styles=[y,i`
      :host {
        position: relative;
