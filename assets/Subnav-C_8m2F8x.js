import{i as h,h as c,k as d}from"./lit-element-Cg_OjzXH.js";import{t as f}from"./custom-element-BhZVzxrc.js";import{t as i}from"./theme-BBRgO7Zu.js";import{n as u}from"./property-C24Ty3RS.js";import{R as b}from"./class-map-CoILYkPe.js";var z=Object.defineProperty,g=Object.getOwnPropertyDescriptor,_=(n,r,a,t)=>{for(var e=t>1?void 0:t?g(r,a):r,o=n.length-1,s;o>=0;o--)(s=n[o])&&(e=(t?s(r,a,e):s(e))||e);return t&&e&&z(r,a,e),e};let v=class extends c{render(){return d`
      <nav>
        <slot></slot>
      </nav>
    `}};v.styles=[i,h`
    ...
    `];v=_([f("pzsh-nav")],v);var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,m=(n,r,a,t)=>{for(var e=t>1?void 0:t?x(r,a):r,o=n.length-1,s;o>=0;o--)(s=n[o])&&(e=(t?s(r,a,e):s(e))||e);return t&&e&&w(r,a,e),e};let p=class extends c{constructor(){super(...arguments),this.href="#",this.active=!1}focus(n){var r,a;(a=(r=this.shadowRoot)==null?void 0:r.querySelector("a"))==null||a.focus(n)}render(){return d`<a
