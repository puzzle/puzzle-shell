import{i as e}from"./preload-helper-CT_b8DTk.js";import{ht as t,ot as n,st as r,ut as i}from"./iframe-CUQ_OtY6.js";import{a,n as o,r as s,t as c}from"./decorate-I8bfxDnw.js";import{r as l,t as u}from"./property-CbRoCnCz.js";import{a as d,c as f,i as p,o as m,s as h,u as g}from"./Topbar-WgT7VS7w.js";import{n as _,t as v}from"./class-map-D2diW1ou.js";import{n as y,t as b}from"./theme-C65ifsUC.js";import{n as x}from"./Icon-BaN3GRk3.js";var S,C=e((()=>{n(),s(),u(),b(),o(),S=class extends r{constructor(...e){super(...e),this.href=`#`}static{this.styles=[y,t`
      a {
        display: flex;
        align-items: center;
    ...
    `]}focus(e){this.shadowRoot?.querySelector(`a`)?.focus(e)}updated(){this.applyHostAttributes()}render(){return i`<a href="${this.href}" role="menuitem">
      <slot></slot>
    </a>`}applyHostAttributes(){let e=this.shadowRoot?.querySelector(`a`);e&&Array.from(this.attributes).filter(({name:e})=>e!==`href`).forEach(({name:t,value:n})=>{e.setAttribute(t,n)})}},c([l({type:String})],S.prototype,`href`,void 0),S=c([a(`pzsh-menu-action`)],S)})),w,T=e((()=>{n(),f(),s(),v(),m(),p(),b(),x(),o(),w=class extends r{static{this.styles=[y,t`
      :host {
        position: relative;
