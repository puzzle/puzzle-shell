import{i as e}from"./preload-helper-xPQekRTU.js";import{V as t,X as n}from"./iframe-DKx5S2XV.js";var r=e((()=>{})),i=e((()=>{})),a=e((()=>{})),o=e((()=>{})),s=e((()=>{})),c=e((()=>{}));function l(){return typeof window<`u`}function u(){return l()&&`pzshBreakpoint`in window&&typeof window.pzshBreakpoint==`number`&&window.pzshBreakpoint||f}function d(e){if(!l())return;let t=document.createElement(`style`);t.innerText=e.toString(),document.querySelector(`body`)?.appendChild(t)}var f,p,m,h=e((()=>{t(),r(),i(),a(),o(),s(),c(),f=800,p=n`
  /* Base colors */
