import{i as p,a as d,x as f}from"./lit-element-JDTHnSco.js";import{t as m}from"./custom-element-BhZVzxrc.js";import{t as n}from"./theme-Raj2EPBn.js";import{n as v}from"./property-DflLml2K.js";var g=Object.getOwnPropertyDescriptor,x=(a,e,l,r)=>{for(var t=r>1?void 0:r?g(e,l):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=o(t)||t);return t};let c=class extends d{render(){return f`
    ...
    `];c=x([m("pzsh-footer")],c);var u=Object.defineProperty,z=Object.getOwnPropertyDescriptor,h=(a,e,l,r)=>{for(var t=r>1?void 0:r?z(e,l):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,l,t):o(t))||t);return r&&t&&u(e,l,t),t};let i=class extends d{constructor(){super(...arguments),this.href="#"}render(){return f`<a href="${this.href}">
      <slot></slot>
    </a>`}};i.styles=[n,p`
      a {
        display: flex;
    ...
    `];h([v({type:String})],i.prototype,"href",2);i=h([m("pzsh-footer-link")],i);
