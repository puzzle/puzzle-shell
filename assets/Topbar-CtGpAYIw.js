import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{d as t,n,o as r,r as i}from"./iframe-Bo65fjee.js";import{i as a,r as o,t as s}from"./decorate-CzIddzQs.js";import{n as c,r as l,t as u}from"./property-Ca7Ongfb.js";import{n as d,t as f}from"./class-map-BH1Jyn2G.js";import{n as p,t as m}from"./theme-B9DBRWyB.js";import{n as h}from"./Icon-Dcv1l4WG.js";function g(e){return l({...e,state:!0,attribute:!1})}function _(){return(_=e((()=>{c()})))()}function v(){return(v=e((()=>{c(),_()})))()}function y(e,t){return e&&e instanceof HTMLElement&&(e.nodeName.toLowerCase()===t||e.closest(t)!=null)}function b(e){e.getBoundingClientRect().bottom>window.innerHeight&&e.scrollIntoView(!1),e.getBoundingClientRect().top<0&&e.scrollIntoView()}function x(){return(x=e((()=>{})))()}function S(e,t){if(t instanceof KeyboardEvent&&t.type===`keydown`&&(t.key===`ArrowUp`||t.key===`ArrowDown`)){let n=e(),r=n.findIndex(e=>e===document.activeElement);t.key===`ArrowUp`?--r:t.key===`ArrowDown`&&(r+=1);let i=n[r];i&&(i.focus(),b(i),t.preventDefault())}}function C(){return(C=e((()=>{})))()}var w;function T(){return(T=e((()=>{n(),o(),m(),w=class extends i{static{this.styles=[p,t`
      :host {
        position: absolute;
    ...
    `]}render(){return r``}},w=s([a(`pzsh-backdrop`)],w)})))()}var E;function D(){return(D=e((()=>{n(),v(),o(),u(),f(),C(),m(),T(),E=class extends i{static{this.styles=[p,t`
      nav {
        position: absolute;
        top: var(--pzsh-topbar-height);
        left: 0;
    ...
    `}},s([g()],E.prototype,`open`,void 0),s([l({type:String})],E.prototype,`scrollContainerSelector`,void 0),E=s([a(`pzsh-menu`)],E)})))()}var O;function k(){return(k=e((()=>{n(),v(),o(),u(),m(),h(),O=class extends i{static{this.styles=[p,t`
      :host {
        display: flex;
        align-items: center;
        height: var(--pzsh-topbar-height);
    ...
    `]}constructor(){super(),this.menuAvailable=!1,this.menuOpen=!1,this.href=``,this.handleMenuChange=this.handleMenuChange.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`pzsh-menu-change`,this.handleMenuChange,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`pzsh-menu-change`,this.handleMenuChange,!0)}handleMenuChange(e){if(e.stopPropagation(),e instanceof CustomEvent){let{available:t,open:n}=e.detail;this.menuAvailable=t,this.menuOpen=n}}toggleMenu(){this.dispatchEvent(new CustomEvent(`pzsh-menu-toggle`))}renderMenuButton(){if(this.menuAvailable){let e=this.menuOpen?`multiply`:`bars`;return r`<button
      ...
      >
        <pzsh-icon name=${e}></pzsh-icon>
          ...
          <slot></slot>
        </a>`:r`<slot></slot>`}render(){return r`${this.renderLogo()} ${this.renderMenuButton()} `}},s([g()],O.prototype,`menuAvailable`,void 0),s([g()],O.prototype,`menuOpen`,void 0),s([l({type:String})],O.prototype,`href`,void 0),O=s([a(`pzsh-topbar`)],O)})))()}export{S as a,v as c,C as i,_ as l,D as n,x as o,T as r,y as s,k as t,g as u};